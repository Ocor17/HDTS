...
class HardDrive(models.Model):
    ...
    manufacturer = models.ChoiceField(db_column='Manufacturer',  blank=True, null=True)
    modelNo = models.IntegerField(db_column='Model Number',  blank=True, null=True)
    hdType = models.ChoiceField(db_column=' Hard Drive Type',  blank=True, null=True)
    connPort = models.ChoiceField(db_column=' Hard Drive Connection Port',  blank=True, null=True)
    hdSize = models.ChoiceField(db_column='Hard Drive Size',  blank=True, null=True)
    hdClass = models.ChoiceField(db_column=' Hard Drive Classification',  blank=True, null=True)
    ...
    hdStatus = models.ChoiceField(db_column='HD Status',  blank=True, null=True)
